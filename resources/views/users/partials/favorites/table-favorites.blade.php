...
<table>
    ...
    <tbody>
        ...
        <tr id="favorite-item-{{ $favorite->id_yeuthich }}">
            <td class="favorite__item" onclick="window.location='{{ route('shop_details', $favorite->product->slug) }}'" style="cursor: pointer;">
...
<div class="mt-4" style="text-align: center">
    @include('users.components.pagination', ['paginator' => $favorites, 'customUrl' => route('favorites.index')])
</div>
