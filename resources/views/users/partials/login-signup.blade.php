            ...
            <div class="signup-content">
                <form class="form-grid" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-input" name="hoten" placeholder="Enter your profile name" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="password-field">
                            <input type="password" class="form-input" name="matkhau" placeholder="Enter your password" required>
                            <button type="button" class="password-toggle">Hide</button>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="password-field">
                            <input type="password" class="form-input" name="matkhau_confirmation" placeholder="Confirm your password" required>
                            <button type="button" class="password-toggle">Hide</button>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-input" name="sodienthoai" placeholder="Enter your Phone Number" required>
                    </div>

                    <div class="form-group">
                        <label class="form-label">What's your date of birth?</label>
                        <div class="date-input">
                            <input type="date" class="form-input" name="ngaysinh" placeholder="MM/DD/YYYY">
                        </div>
                    </div>

                    <div class="form-group full-width">
                        <label class="form-label">Address <span class="required">*</span></label>
                        <textarea class="form-input" name="diachi" placeholder="Enter your Address" required></textarea>
                    </div>
