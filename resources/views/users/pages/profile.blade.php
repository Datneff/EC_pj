                        ...
                        <div class="col-md-8">
                            ...
                            <div class="row mb-3">
                                <div style="flex: 0 0 50%; padding: 0 15px;">
                                    <label for="user-gender" style="display: block; margin-bottom: 8px;">Gender</label>
                                    <select id="user-gender" name="gioitinh" style="width: 100%; padding: 8px; border: 1px solid #ced4da; border-radius: 4px;">
                    ...
                    <div class="row">
                        @forelse ($favorites as $favorite)
                            <div class="col-md-4 mb-4">
                                <div class="card">
                                    <img src="{{ asset('storage/' . ($favorite->product->images->isNotEmpty() ? $favorite->product->images->first()->duongdan : 'img/products/default.jpg')) }}"
                                        class="card-img-top" alt="{{ $favorite->product->tensanpham }}"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <form action="{{ route('favorites.destroy', $favorite->id_sanpham) }}"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <a href="{{ route('shop_details', ['slug' => $score->product->slug]) }}"
